...
const truck1 = new Truck(Cli.generateVin(), "red", "Ford", "F-150", 2021, 5000, 120, [new Wheel(18, 'Goodyear'), new Wheel(18, 'Goodyear'), new Wheel(18, 'Goodyear'), new Wheel(18, 'Goodyear')], 10000);
